...
export function offerUpdatedMail(need: Need, offer: Offer) {
  const subject = `[NeedPort] オファー更新: ${offer.vendor_name}`;
  ...
  const bodyHtml = `
    ...
    <p>オファーの内容を確認し、必要に応じて対応してください。</p>
  `;
