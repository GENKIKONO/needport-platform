...
// 検索ボタンスタイル
export const searchButton = "bg-[#0B5FA6] text-white rounded-lg px-6 py-2 font-semibold flex items-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-400 hover:bg-[#094A85]";

// フォームカードスタイル
export const formCard = "bg-white rounded-2xl shadow-[0_8px_24px_rgba(0,0,0,0.08)] p-4 sm:p-6";

// アイコン色
export const iconColor = "text-[#196AA6]";
