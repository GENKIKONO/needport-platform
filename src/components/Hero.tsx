  ...
  return (
    <section className="relative overflow-hidden rounded-2xl bg-white px-6 py-16 md:py-24 border-b border-neutral-100">
      <div className="max-w-3xl mx-auto text-center">
        <div className="text-4xl md:text-6xl font-extrabold drop-shadow-sm text-balance leading-tight">実現する力</div>
        <p className="mt-4 text-lg md:text-xl text-neutral-600 leading-relaxed max-w-prose mx-auto">需要が見えるから、安心して提供できる。</p>
        <p className="mt-1 text-neutral-600 leading-relaxed">確実なニーズに基づくサービス創造</p>
