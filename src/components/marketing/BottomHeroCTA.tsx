    ...
    <section className="mx-auto max-w-6xl px-4 mt-16">
      <div className="rounded-3xl bg-gradient-to-br from-indigo-600 via-sky-600 to-cyan-500 text-white px-6 py-10 md:px-10 md:py-14 shadow-lg">
        ...
        <div className="mt-6 flex gap-3 flex-wrap">
          <Link href="/needs/new" className="inline-flex items-center gap-2 rounded-xl bg-white text-sky-700 px-4 py-2 font-semibold shadow hover:shadow-md transition-shadow">
            <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
            </svg>
            ニーズを投稿
          </Link>
          <Link href="/needs" className="inline-flex items-center gap-2 rounded-xl bg-white/10 backdrop-blur-sm border border-white/30 text-white px-4 py-2 font-semibold hover:bg-white/20 transition-colors">
            <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
