-- Production Auto-Provisioning Enablement Script - LIVE VERSION
-- Execute this in Supabase SQL Editor for production environment
-- Date: 2025-09-15
-- Updated with Live Clerk User IDs from Test environment
...
-- ============================================================================
-- Step 2: Create profiles for existing users (Live User IDs)
-- ============================================================================

-- 2.1 Insert profile for genkikono.2615@gmail.com (COMMENTED OUT - Live environment has 0 users)
-- INSERT INTO profiles (clerk_user_id, email, full_name, role, created_at, updated_at)
-- VALUES (
--   'user_32bLa5iVBa4KBRldf4nRvKXLVnS', -- Test Clerk user ID (Live environment has 0 users)
...
-- 2.2 Insert profile for genkikono.kochi@gmail.com (COMMENTED OUT - Live environment has 0 users)
-- INSERT INTO profiles (clerk_user_id, email, full_name, role, created_at, updated_at)
-- VALUES (
--   'user_32b0oVi0qqVcHfNOiXef4mCTwHd', -- Test Clerk user ID (Live environment has 0 users)
...
-- 2.3 Insert profile for test@needport.dev (COMMENTED OUT - Live environment has 0 users)
-- INSERT INTO profiles (clerk_user_id, email, full_name, role, created_at, updated_at)
-- VALUES (
--   'user_32iEPCzsCKGMHC5OPJj7sJm6Geh', -- Test Clerk user ID (Live environment has 0 users)
--   'test@needport.dev',
--   'Test User',
--   'user',
--   NOW(),
